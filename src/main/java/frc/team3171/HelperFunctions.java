...
public class HelperFunctions {
	 ...
	 * 
	 * @param deadzoneRange The range that will be used when adjusting the inputed value.
	 * @param currentValue  The original unaltered value that should range from -1.0 to 1.0.
	...
	/**
	 * This function returns a value adjusted for the inputed deadzone and maps it to the full range.
	 * 
	 * @param deadzoneRange The range that will be used when adjusting the inputed value.
	 * @param currentValue  The original unaltered value that should range from -1.0 to 1.0.
	 * @return The value adjusted for the given deadzone range.
	 ...
	 * 
	 * @param deadzoneRange The range that will be used when adjusting the inputed value.
	 * @param currentValuse An array of the original unaltered values that should range from -1.0 to 1.0.
	 * @return An array, in the same order as they were given, of the values adjusted for the given deadzone range.
	 */
	public static double[] Deadzone_With_Map(final double deadzoneRange, final double currentValue, final double... currentValues) {
	...
	/**
	 * Determines if the currentValue is within range of the desiredValue by the given percentage.
	 * 
	 * @param currentValue    The current value to compare.
	 * @param desiredValue    The desired value to compare the current value to.
	 * @param errorPercentage The desired percent error margin allowed for the calculation.
	 * @return true if the currentValue is within the desiredValue by the given percent margin, false otherwise.
	 */
	public static boolean Within_Percent_Error(final double currentValue, final double desiredValue, final double errorPercentage) {
	 ...
	 * 
	 * @param minValue The minimum value of the non-continuous range.
	 * 
	 * @param maxValue The maximum value of the non-continuous range.
	 * 
	...
	/**
	 * Turns a gyros raw values into angles that are more useful (-180.0 degrees to 180.0 degrees), where 0 is the front and -180.0 is 180 degrees counterclockwise from 0 and 180.0 is 180 degrees
	 * clockwise from 0.
	 * 
	...
	/**
	 * Returns the shortest displacement in the best direction from the currentValue to the desiredValue. This function will normalize (scale the values from the provided minValue and maxValue) both
	 * the currentValue and the desiredValue and will return the displacement as a normalized value as well.
	 * 
	...
	/**
	 * Returns the shortest gyro displacement in the best direction from the currentValue to the desiredValue. This function will normalize, scale the values from -180.0 degrees to 180.0 degrees, both
	 * the currentValue and the desiredValue and will return the displacement as a normalized value as well.
	 * 
	 * @param currentValue The current gyro value in degrees.
	 * @param desiredValue The desired gyro value in dgerees.
	 * @return The shortest gyro displacement representing the best direction to reach the desired value with the least amount of turning.
	 */
